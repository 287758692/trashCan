        ...
        <div class="page-content">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">垃圾桶-修改</div>
                </div>
                <div class="portlet-body">
	                <form class="form-horizontal" id="trashCanAmdForm" name="trashCanAmdForm" >
	                    <div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input type="text" class="form-control" id="address" value="${address}" name="address" readonly>
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-2"></div>
								...
								<div class="col-md-3">
									<input type="date" class="form-control" id="useDate" name="useDate" value="${useDate}">
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-2"></div>
								...
								<div class="col-md-3">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div id="preview1" class="fileinput-preview thumbnail" data-trigger="fileinput" >
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div id="preview2" class="fileinput-preview thumbnail" data-trigger="fileinput" >
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div id="preview3" class="fileinput-preview thumbnail" data-trigger="fileinput" >
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div id="preview4" class="fileinput-preview thumbnail" data-trigger="fileinput" >
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div id="preview5" class="fileinput-preview thumbnail" data-trigger="fileinput">
