...
import com.trashCan.model.AccessToken;
...
public  class WxAccessToken {
	...
	public synchronized static String getAccessToken() {
		...
		try {
			...
			//获取文件流
			InputStream fis = WxAccessToken.class.getClassLoader().getResourceAsStream(FileName);
			...
			if ((current_time - long_last_time) / 1000 >= int_expires_in) {
				...
				if (j_access_token != null && j_expires_in != null) {
					...
					URL url_ = WxAccessToken.class.getClassLoader().getResource(FileName);
